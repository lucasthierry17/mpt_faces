...
def live(args):
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            ...
            transformed_face = validation_transform(pil_image)  # Directly using the transform here
            ...
            cv.putText(frame, label, (new_x + 8, new_y - 6), cv.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv.LINE_AA)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Live Face Recognition with Adjustable Border")
    parser.add_argument("--border", type=float, required=True, help="Percentage to increase the face bounding box")
